...
import com.sleepace.z400tsdk.demo.util.BleDeviceNameUtil;
...
public class SearchBleDeviceActivity extends BaseActivity {
    ...
    private boolean checkZ400T(String deviceName) {
		if (deviceName == null) return false;
		Pattern p1 = Pattern.compile("^(Z40T2)[0-9a-zA-Z]{8}$");
...
//		            	SdkLog.log(TAG+"------------onLeScan deviceName:" + deviceName);
		            	...
		            	ble.setDeviceType(DeviceType.DEVICE_TYPE_Z400T_2);
